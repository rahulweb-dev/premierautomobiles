  ...
  return (
    ...
    <main className="max-w-5xl px-4 py-10 mx-auto mt-10 leading-relaxed text-gray-800">
      ...
      <h2 className="mb-10 text-xl font-semibold text-center">
        Premier Automobiles – Statement of Terms and Conditions
      </h2>

      {/* Introduction */}
      <section className="mb-10 space-y-4">
        <p>
          At <strong>Premier Automobiles</strong>, we value your privacy and are committed
      ...
      <section className="mb-10 space-y-4">
        ...
        <p>
          ...
          identifiable information collected by Premier Automobiles when you visit
          our website or use our services. This policy does not extend to the
          practices of companies that Premier Automobiles does not own, control, or
          manage, nor to individuals not employed by Premier Automobiles.
        </p>
      </section>
      ...
      <section className="mb-10 space-y-4">
        ...
        <p>
          ...
          Premier Automobiles (operated by Premier Automobiles Pvt. Ltd.) to contact you
      ...
      <section className="mb-10 space-y-4">
        ...
        <p>Premier Automobiles may collect personally identifiable information when you:</p>
        <ul className="ml-4 space-y-1 list-disc list-inside">
          <li>Register for a Premier Automobiles account</li>
        ...
        <p>
          ...
          Premier Automobiles uses your data to:
        </p>
        <ul className="ml-4 space-y-1 list-disc list-inside">
      ...
      <section className="mb-10 space-y-4">
        ...
        <p>
          Premier Automobiles <strong>does not sell or rent</strong> your personally
        ...
        <ul className="ml-4 space-y-1 list-disc list-inside">
          ...
          <li>
            Your actions violate the Premier Automobiles Terms of Service or other
            usage guidelines
          </li>
        </ul>
      </section>
      ...
      <section className="mb-10 space-y-4">
        ...
        <p>
          Your Premier Automobiles account information is protected by a password
      ...
      <section className="mb-10 space-y-4">
        ...
        <p>
          Premier Automobiles may update these Terms and Conditions from time to
